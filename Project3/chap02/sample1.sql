...
CREATE TABLE student_t  (
    ...
    s_class NUMBER,
    gender CHAR(1),
    s_teacher varchar2(100)
);
--코멘트 달아주기
COMMENT ON COLUMN student_t.s_id IS '학생번호';
...
COMMENT ON COLUMN student_t.s_teacher IS '해당 과목 담당 선생님';
