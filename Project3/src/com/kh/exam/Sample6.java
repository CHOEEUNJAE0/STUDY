...
public class Sample6 {
	...
	public static void main(String[] args) {
		/*
		 * TB_STUDENT 테이블에서 학번, 이름, 주민번호, 학과명, 휴무유무에 대한 데이터를 조회하여
		 * 컬렉션 객체 저장을 하도록 한다.
		 *  - 주민등록번호는 생년월일과 성별 구분을 제외하고는 나머지 번호에 대해
		 *    숨김(*) 처리를 하도록 한다.
		 *    -List 컬렉션에 Map 컬렉션이 저장 되는 형태로 만든다.
		 *    -Map 컬렉션에는 데이터 베이스에서 조회한 컬럼명은 Map의 키로 
		 *    컬럼 값은 Map의 값으로 저장 되게 한다.
		 *    - 컬럼 이름은 반드시 위에서 제시한 한글명으로 별칭을 부여하도록 한다.
		 */
