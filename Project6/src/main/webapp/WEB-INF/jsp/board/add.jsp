...
<body>
	...
	<section class="container">
		...
		<ol>
			...
			<li>제목만 있는 글이 만들어지기 위해 Ajax를 통해 서버에 제목을 전달하면 서버에서는 해당 제목의 글을 데이터베이스에 생성 후 생성한 글의 ID를 클라이언트에 전달한다.</li>
			<li>ID를 받은 클라이언트는 페이지 내부에 숨겨진 요소에 ID 값을 지정한다.</li>
			<li>사용자가 글 내용을 작성 후 저장 버튼을 누르면 서버에 ID, 제목, 글 내용 등의 정보를 전달하여 이전에 저장 해 둔 데이터에 업데이트 처리한다.</li>
		</ol>
		<div class="card text-dark bg-light">
			<div class="card-body">
				...
				<div class="row mb-3">
					<textarea form="id_form" class="form_control" rows="10"
