...
function sendAjax() {
	$.ajax({
		...
		success: function(data, status) {
			...
			//여기에 기능을 구현
			//data 인자는 서버가 전송한 데이터이다.
			console.log(data);
			console.log(data.firstName); //화면에 보여주고 싶은것은 .키값 적어주면 된다.
...
<body>
	<div>
		<input type="button" value="버튼" onclick="sendAjax();"> <!-- 클릭하면 위에 sendAjax 동작, 그리고 나면 위에 작성한 c:url 위치로 이동-->
	</div>
	<hr>
	<div>
