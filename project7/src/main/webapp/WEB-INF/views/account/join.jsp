...
<%--@ page import="javax.servlet.http.HttpSession" import="com.web.account.model.*" --%>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text"
								name="username" value="${accountVO.username}" oninput="isDuplication(this);" required>
							<%--accountVO객체에 맞춰서 맵핑이 되게 하려며 param.username 말고 accountVO.username 해 주면 된다. --%>
							<div class=""></div>
						</div>
					</div>
					<div class="row mb-3">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-10">
							<input class="form-control" type="email" id="id_email"
								name="email" value="${accountVO.email}" >
						</div>
					</div>
					<div class="row mb-3">
